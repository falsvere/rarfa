...
template<> POWERIKRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_PowerIK_Ground>()
{
	...
	struct Z_CompiledInDeferFile_FID_The_Armour_Project_Plugins_PowerIK_HostProject_Plugins_PowerIK_Source_PowerIKRuntime_Public_AnimNode_PowerIK_Ground_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_The_Armour_Project_Plugins_PowerIK_HostProject_Plugins_PowerIK_Source_PowerIKRuntime_Public_AnimNode_PowerIK_Ground_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_The_Armour_Project_Plugins_PowerIK_HostProject_Plugins_PowerIK_Source_PowerIKRuntime_Public_AnimNode_PowerIK_Ground_h_3860431366(TEXT("/Script/PowerIKRuntime"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_The_Armour_Project_Plugins_PowerIK_HostProject_Plugins_PowerIK_Source_PowerIKRuntime_Public_AnimNode_PowerIK_Ground_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_The_Armour_Project_Plugins_PowerIK_HostProject_Plugins_PowerIK_Source_PowerIKRuntime_Public_AnimNode_PowerIK_Ground_h_Statics::ScriptStructInfo),
		nullptr, 0);
